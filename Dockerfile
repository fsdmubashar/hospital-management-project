...
RUN groupadd --gid "${APP_GID}" hospitalgroup \
    && useradd --uid "${APP_UID}" --gid hospitalgroup --create-home --shell /usr/sbin/nologin hospitaluser
...
RUN mkdir -p /app/logs /app/backups /app/reports_output /app/data \
    ...
    && chown hospitaluser:hospitalgroup /app/logs/production.log \
    && chmod 660 /app/hospital.db /app/logs/production.log \
    && chmod 770 /app/logs /app/backups /app/reports_output /app/data \
